...
class Model(nn.Module):
    ...
    def forward(self,pc_input,cen_gt = None, m_gt=None, train = False):
        ...
        if train:
            ...
            pc_input = (pc_input - cen_gt.unsqueeze(-2))/m_gt.unsqueeze(-1).unsqueeze(-2)
        else:
            ...
            pc_input = (pc_input - center.unsqueeze(-2))/m.unsqueeze(-2)
